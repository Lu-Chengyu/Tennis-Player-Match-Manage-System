...
describe('frontend: player create', function () {
  const DEFAULT_PATH   = Fixture.URL_MAP.FRONT_PLAYER_CREATE.path;
  const DEFAULT_METHOD = Fixture.URL_MAP.FRONT_PLAYER_CREATE.method;
